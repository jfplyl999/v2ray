...
sed -i '6a199.232.5.194   github.global.ssl.fastly.net' hosts
sed -i '7a199.232.28.133  raw.githubusercontent.com' hosts
}
...
udp2raw_server_install(){
	...
	chmod +x udp2raw_amd64 run.sh kcpserverrestart.sh
